System.register(['angular2/core', './hero.service', 'angular2/router', 'angular2/http'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, hero_service_1, router_1, http_1;
    ...
    return {
        ...
        execute: function() {
            HeroListComponent = (function () {
                function HeroListComponent(http, _service, _router, routeParams) {
                    this.http = http;
                ...
                HeroListComponent.prototype.get = function () {
                    this._service.getValues();
                };
                HeroListComponent.prototype.post = function () {
                ...
                HeroListComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [http_1.Http, hero_service_1.HeroService, router_1.Router, router_1.RouteParams])
                ], HeroListComponent);
